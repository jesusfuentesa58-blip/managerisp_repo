...
class EditPlan extends EditRecord
{
    ...
    /**
     * Después de guardar cambios en el Plan, sincronizamos perfiles en los routers seleccionados.
     */
    protected function afterSave(): void
    {
        // NO llamar a parent::afterSave() — la clase padre no lo define.
        $plan = $this->record;
    ...
    /**
     * Reutiliza la misma lógica que en CreatePlan.
     */
